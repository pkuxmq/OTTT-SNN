...
def main():
    ...
    net = spiking_vgg.__dict__[args.model](single_step_neuron=neuron.OnlineLIFNode, surrogate_function=surrogate.Sigmoid(alpha=4.), track_rate=True, c_in=2, num_classes=11, grad_with_rate=True, tau=args.tau, neuron_dropout=args.drop_rate, fc_hw=1, v_reset=None)
    #print(net)
